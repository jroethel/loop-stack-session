...
Per-unit model choice follows the routing chain (`config/routing/model-benchmarks.md`); this file does not restate it (the promotion ladder and prior tier live in that single home).
One ringer-specific mechanic stays here:
